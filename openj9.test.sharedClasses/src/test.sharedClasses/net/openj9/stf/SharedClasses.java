...
public class SharedClasses implements SharedClassesPluginInterface {
	...
	private enum Modes {
        ...
        SCM23("-Xshareclasses:name=${cacheName},cacheDir=${cacheDir}${cacheOperation} -Xjit:compThreadPriority=2,verbose={compilePerformance},verbose={inlining},vlog=vlog.txt -Xaot:forceAoT,count=1"),
