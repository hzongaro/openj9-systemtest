...
public class SharedClasses implements SharedClassesPluginInterface {
	...
	private enum Modes {
        ...
        SCM23("-Xshareclasses:name=${cacheName},cacheDir=${cacheDir}${cacheOperation} -Xaot:forceAoT,count=1 -Xjit:verbose={compilePerformance},verbose={inlining},vlog=vlog.log"),
