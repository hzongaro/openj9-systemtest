...
public class SharedClasses implements SharedClassesPluginInterface {
	...
	private enum Modes {
        ...
        SCM23("-Xshareclasses:name=${cacheName},cacheDir=${cacheDir}${cacheOperation} -Xaot:forceAoT,exclude={*Test_Init*.makeString*\|*Test_Init*.stringOperations*\|*TestClass*.makeString*\|*TestClass*.stringOperations*},count=1 -Xjit:verbose={compilePerformance},verbose={inlining},vlog=vlog.txt"),
