...
public class SharedClasses implements SharedClassesPluginInterface {
	...
	private enum Modes {
        ...
        SCM23("-Xshareclasses:name=${cacheName},cacheDir=${cacheDir}${cacheOperation} -Xaot:forceAoT,count=1 -Xjit:verbose={compilePerformance},vlog=vlog.txt -Xdump:java:events=vmstop"), 
