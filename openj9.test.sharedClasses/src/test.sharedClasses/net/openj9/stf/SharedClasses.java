...
* and is available at http://eclipse.org/legal/epl-S2.0 or the Apache License, 
...
public class SharedClasses implements SharedClassesPluginInterface {
	...
	private enum Modes {
        ...
        SCM23("-Xshareclasses:name=${cacheName},cacheDir=${cacheDir}${cacheOperation} -Xaot:forceAoT,count=1 -Xjit:verbose={compilePerformance},vlog=vlog.txt -Xdump:java:events=vmstop,file=javainfo.%pid.%seq"), 
